    ...
    for i in range(10):
        try:
            ...
            envio = Envio.objects.create(
                ...
                remitente_nombre=admin.get_full_name() or admin.username,
                remitente_direccion="Oficina Central PACKFY, La Habana, Cuba",
                remitente_telefono="+53 7123456",
                remitente_email=admin.email,
                ...
                destinatario_direccion=f"{random.choice(direcciones_cuba)}, {destino_ciudad}, Cuba",
            ...
            print(f"  ✅ #{envio.numero_guia}: {envio.destinatario_nombre}")
            print(
